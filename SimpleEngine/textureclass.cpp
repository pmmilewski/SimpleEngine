...
bool TextureClass::Initialize(ID3D11Device *device, ID3D11DeviceContext *deviceContext, const char *filename)
{
	...
	deviceContext->UpdateSubresource(m_texture, 0, NULL, m_targaData, rowPitch, 0); //UpdateSubresource (not Map/Unmap) because it won't be updated on regular basis.
